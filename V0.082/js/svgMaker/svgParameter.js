...
//~ on affiche une vue mais faut passer le model en parametre
  var svgParameterView = Backbone.View.extend({
		...
		initialize: function(){
			...
			this.model.bind('change', this.onChangeToo, this);
        },
		...
		onChangeToo: function (){
			var elementCurr=this.model.get("id");
			var valElemCurr=this.model.get("value");
			//~ this.model.set("value",this.model.get("value"));
			//alert("on change"+elementCurr+"  "+valElemCurr);
			//this.render retourne une valeur.
